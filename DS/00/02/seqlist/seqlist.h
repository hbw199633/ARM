...
extern int inr_pos_seqlist(seqlist *sq,datatype va,int pos);
extern int del_va_seqlist(seqlist *sq,datatype va);
extern int del_pos_seqlist(seqlist *sq,int va);
extern int find_va_seqlist(seqlist *sq,datatype va);
extern int show_seqlist(seqlist *sq);
extern int free_seqlist(seqlist *sq);
extern int full_seqlist(seqlist *sq);
extern int empty_seqlist(seqlist *sq);
